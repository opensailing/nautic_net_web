defmodule NauticNetWeb.CoreComponents do
  @moduledoc """
  ...
  def modal(assigns) do
    ~H"""
    <div id={@id} phx-mounted={@show && show_modal(@id)} class="relative z-[1000] hidden">
  ...
  def flash(assigns) do
    ...
    <div
      ...
      role="alert"
      class={[
        "fixed hidden top-2 right-2 w-80 sm:w-96 z-[1000] rounded-lg p-3 shadow-md shadow-zinc-900/5 ring-1",
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(NauticNetWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(NauticNetWeb.Gettext, "errors", msg, opts)
    # end
